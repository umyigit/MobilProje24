...
const bazal = require('../../../assets/images/bazal.jpg');
...
const navigation = useNavigation<NavigationType>();
  const boxes = [
    {
      ...
      content: [
        "Etkinin başlaması: 1-2 saat",
        "Etki süresi: 20-24 saat",
        "Her gün düzenli olarak aynı saatte yapılmalıdır.",
        "Genellikle günde 1 kez yapılır.",
        "Açlık şekerinde etkilir.",
      ]
    },
    {
  ...
  return (
    <ImageBackground source={bazal} style={styles.backgroundImage}>
      <ScrollView style={styles.container}>
        <TouchableOpacity onPress={() => navigation.goBack()} style={styles.headerLeft}>
          <FontAwesome name="arrow-circle-o-left" size={30} color="black" />
        </TouchableOpacity>
        <Text style={styles.mainTitle}>BAZAL İNSÜLİNLER</Text>
        {boxes.map((box, index) => (
