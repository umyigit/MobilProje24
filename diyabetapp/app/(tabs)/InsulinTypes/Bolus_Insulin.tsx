...
const bolus = require('../../../assets/images/bolus.jpg');
...
const navigation = useNavigation<NavigationType>();
  const boxes = [
    {
      ...
      content: [
        "Etkinin başlaması: 15-60 dakika",
        "Etki süresi: 3-6 saat",
        "Genelde sabah,öğle,akşam olmak üzere yemeklerden 5-10 dakika önce yapılır.",
        "Tokluk şekerinde etkilidir.",
      ]
    },
    {
  ...
  return (
    <ImageBackground source={bolus} style={styles.backgroundImage}>
      <ScrollView style={styles.container}>
        <TouchableOpacity onPress={() => navigation.goBack()} style={styles.headerLeft}>
          <FontAwesome name="arrow-circle-o-left" size={30} color="black" />
        </TouchableOpacity>
        <Text style={styles.mainTitle}>BOLUS İNSÜLİNLER</Text>
        {boxes.map((box, index) => (
